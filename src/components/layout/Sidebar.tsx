      ...
      <aside id="layout-menu" className="layout-menu menu-vertical menu bg-menu-theme">
        <div className="app-brand demo">
          ...
          <a href="index.html" className="app-brand-link">
            ...
            <span className="app-brand-text demo menu-text fw-bolder ms-2">A.I. Rahat</span>
          </a>

          <label htmlFor="SideBarMenu" className="sidebar-close-toggle menu-link text-large ms-auto d-block d-xl-none">
            ❌
          </label>
        </div>
        ...
        <ul className="menu-inner py-1">
          ...
          <li className="menu-item ">
            <NavLink to="/pos" className="menu-link">
              <i className='bx  bx-store-alt'  ></i><div data-i18n="Analytics"> POS</div>
            </NavLink>
          </li>
          {/* <!-- Users --> */}
